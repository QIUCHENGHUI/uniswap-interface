...
import { useMooniSwapPair } from '../../data/Reserves'
// usePair
...
export function useDerivedBurnInfo(
  ...
  // pair + totalsupply
  const [, pair] = useMooniSwapPair(wrappedUniswapZeroCurrency(currencyA, chainId), wrappedUniswapZeroCurrency(currencyB, chainId))
