...
import { yam as yamV1Address } from '../../../../constants/yam/tokenAddresses'
...
import useUnharvested from '../../../../hooks/yam/useUnharvested'
...
const MigrationInstructionsModal: React.FC<ModalProps> = ({ onDismiss }) => {
  ...
  return (
    <Modal>
      ...
      <ModalContent>
        <StyledStep>
          <StyledCheckboxWrapper>{!!account ? '✅' : '⬜'}</StyledCheckboxWrapper>
          <div>
            <Label text="Step 1" />
          ...
          {!account && (
            <div>
              <Button onClick={onPresentUnlockModal} size="sm" text="Unlock Wallet" />
            </div>
          )}
        </StyledStep>
        ...
        <StyledStep>
          <StyledCheckboxWrapper>{hasHarvested ? '✅' : '⬜'}</StyledCheckboxWrapper>
          <div>
            <Label text="Step 2" />
          ...
          {!hasHarvested && (
            <div>
              <Button disabled={!account} href="/farms" size="sm" text="View Farms" />
            </div>
          )}
        </StyledStep>
        ...
        <StyledStep>
          <StyledCheckboxWrapper>{hasApproved ? '✅' : '⬜'}</StyledCheckboxWrapper>
          <div>
            <Label text="Step 3" />
          ...
          {!hasApproved && (
            <div>
              <Button disabled={!account || approvalDisabled} onClick={handleApprove} size="sm" text="Approve" />
            </div>
          )}
        </StyledStep>
        ...
        <StyledStep>
          <StyledCheckboxWrapper>⚠️</StyledCheckboxWrapper>
          <div>
