...
import useFarm from '../../../hooks/yam/useFarm'
import useRedeem from '../../../hooks/yam/useRedeem'
...
const Farm: React.FC = () => {
  ...
  return (
    <>
      <PageHeader icon={icon} subtitle={`Deposit ${depositTokenName} and earn ${earnTokenName}`} title={name} />
      <StyledFarm>
        <StyledCardsWrapper>
          <StyledCardWrapper>
          ...
          <Spacer />
          <StyledCardWrapper>
            <Stake poolContract={contract} tokenContract={tokenContract} tokenName={depositToken.toUpperCase()} />
          </StyledCardWrapper>
        </StyledCardsWrapper>
        <Spacer size="lg" />
        <div>
